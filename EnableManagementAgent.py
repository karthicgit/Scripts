...
for instance in list_response:
    ...
    #Check the image is Oracle Linux .This is to avoid checking Windows operating system. You can add other condition if needed.
    if image_response.operating_system == "Oracle Linux":
        plugin_list = instance.agent_config.plugins_config
        for plugin in plugin_list:
            if plugin.name == "Management Agent":
